...
class MeasureExecutionTime:
    ...
    @MeasureExecutionTime(name="function description")
    def function()

    with MeasureExecutionTime(name="wrapped code block description"):
        # your code
    """
    ...
    def __enter__(self):
        logger.info("Entering timed context: {}".format(self._name))
